...
$db = new DB_connect($host='localhost',$user='root',$pass='root',$db='trainee');
// create table
...
$db->insertRow($tableName,$columns,['aashish','aashish@123','aashish@localhost']);
$db->insertRow($tableName,$columns,['vikash','vikash@123','vikash@localhost']);
$db->insertRow($tableName,$columns,['kavya','kavya@123','kavya@localhost']);
$db->insertRow($tableName,$columns,['aman','aman@123', 'aman@localhost']);
$db->insertRow($tableName,$columns,['ravi','ravi@123','ravi@localhost']);
// get row
